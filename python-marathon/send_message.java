...
// telegramUserQueryParams['idIs'] = '1220861479'; //ДЕБАГ - только мне слать 970719107 394735340 - Максимов 283730443 - Кравцова
...
def notifyUser = {tgUser, userData -> 
  ...
  //  if (dayNumberSend==1){dayNumberSend = 2;}
    ...
    commonActions.setUserVariable(userData.user, 'sentPythonBotScreenshotToday', false);
 ...
 //  marathonDay = Integer.parseInt(commonActions.getUserVariable(user, 'dayNumberDone', 0));
    ...
    // Вернуться, если переделать стартовое сообщение 
    
    def blockHashes = ['1':'jklmnop157','2':'klmnop6158','3':'op67892162','4':'nop6789161','5':'p678923163','6':'mnop678160','7':'6789234164','8':'tuvwxyz139','9':'uvwxyz0140','10':'vwxyz01141','11':'wxyz01a142','12':'xyz01ab143'];

    debug.log('dayNumberSend+1='+marathonDay);
    ...
    debug.log('dayNumberSend+1='+taskNumber);
